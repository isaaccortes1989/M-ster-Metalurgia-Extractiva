y   =  c(0.37, 0.706, 0.716, 0.746, 0.785, 0.797, 0.844, 0.855, 0.858,
...
library(gamlss)
weibull <- gamlss(y~1,family="WEI")
summary(weibull)

gm <- gamlss(y~1,family="GA")
summary(gm)

ex <- gamlss(y~1,family="EXP")
summary(ex)
...
esperanza, varianza, asimetria y kurtosis
